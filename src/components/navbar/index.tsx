...
const Navbar = () => {
  ...
  const tabs: TabProps[] = [
    ...
    },
    {
      ...
      href: `/dashboard//style-guide?projectId=${projectId}`,
    ...
    <div className="grid grid-cols-2 lg:grid-cols-3 p-6 fixed top-0 left-0 right-0 z-50">
      ...
      <div className="flex items-center gap-4 justify-end">
        <span className="text-sm text-white/50">
          {/* {creditsBalance} */} creditos
        </span>
        <Button className="rounded-full size-12 flex items-center justify-center backdrop-blur-xl bg-white/[0.08] border border-white/[0.12] saturate-150 hover:bg-white/[0.12]">
